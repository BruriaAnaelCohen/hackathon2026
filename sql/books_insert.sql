-- ===================================================================
-- Books Sample Data - 40 Rows
-- ===================================================================

USE HACKATHON2026;
GO

-- Only insert if Books table is empty
IF (SELECT COUNT(1) FROM Books) = 0
BEGIN
    INSERT INTO Books
    ...
    PRINT '40 books inserted successfully.';
END
ELSE
BEGIN
    PRINT 'Books table already has data. Skipping insert.';
END
GO
